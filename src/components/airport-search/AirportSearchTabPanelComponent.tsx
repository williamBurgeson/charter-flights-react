...
import NearestAirportsComponent from './NearestAirportsComponent'
import AirportsMapComponent from './AirportsMapComponent'
...
export default function AirportSearchTabPanelComponent() {
  ...
  return (
    <div className="airport-search-tab-panel-component">
      <Box className="airport-search-tab-panel-box">
